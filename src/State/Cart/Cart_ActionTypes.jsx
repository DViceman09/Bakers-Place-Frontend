...
export const CLEAR_CART_REQUEST = 'CLEARE_CART_REQUEST';
export const CLEAR_CART_SUCCESS = 'CLEARE_CART_SUCCESS';
export const CLEAR_CART_FAILURE = 'CLEARE_CART_FAILURE';
